...
from experiments import addition_experiments, deletion_experiments, all_experiments, final_experiment

logging.config.fileConfig('config/logging.conf', disable_existing_loggers=False, defaults={'filename': 'experiments-final.log'})
